 ...
 static navigationOptions = {
  ...
  renderImage() {
    return (
      <Image
        styleName="large" 
        source={{ uri:'http://s3.amazonaws.com/v4.static.shoutem.com/apps/267/imageqnW38M_1hUKupHfMzVf1tQ.png' }}
  ...
  renderInfo() {
    return (
      <View styleName="md-gutter-horizontal md-gutter-bottom">
        <Html body={`<b>Programmer Ganteng</b> <br>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum. `} />
      </View>

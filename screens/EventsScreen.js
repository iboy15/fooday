...
import {
  View,Text,StyleSheet,Platform,SafeAreaView,StatusBar,ScrollView
} from 'react-native';
...
render () {
  const example1 = this.mainExample('Near You', 'Default layout | Loop | Autoplay | Parallax | Scale | Opacity | Pagination with tappable dots');
